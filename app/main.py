...
async def optimize(request: OptimizeRequest) -> OptimizeResponse:
    prediction_df, prediction_gameweek = load_predictions(DATA_DIR, request.season, request.gameweek)
    ...
    if resolved_gameweek != prediction_gameweek:
        prediction_df, prediction_gameweek = load_predictions(DATA_DIR, request.season, resolved_gameweek)
